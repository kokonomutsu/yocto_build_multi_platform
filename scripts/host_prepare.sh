...
if [ -d "/mnt/ssd" ]; then
    ...
    mkdir -p /mnt/ssd/downloads-s905x3 /mnt/ssd/downloads-rpi4 /mnt/ssd/downloads-rk3588
    mkdir -p /mnt/ssd/sstate-cache-s905x3 /mnt/ssd/sstate-cache-rpi4 /mnt/ssd/sstate-cache-rk3588
